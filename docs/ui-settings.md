...
1. **Палитра.** В проекте три разные: T03 (`#14191e` / `#1c252d` / `#8ebfe1`), `prototype.css` (`#0A0C10` / `#F0A500` / `#00C8E0`) и константы `UIBuilder`. Макет использует `prototype.css`. Предлагаю зафиксировать её и поправить T03.
